 ...
 * 
 * For now, items can only act on the player by changing their look distance, but more features
 * could be added in the future, such as increasing attack points or defence against attack.
 */

public abstract class GameItem {
	// amount of the current item there is; only really for gold
	...
	/**
	 * Checks if the item can be "retained" by the player, i.e., the player doesn't consume it
	 * instantly (like health) but holds on to it, like sword.
	 * 
