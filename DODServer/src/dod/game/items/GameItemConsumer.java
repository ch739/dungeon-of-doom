...
/**
 * An interface implemented by anything that can "consume an item". This allows the item to act on
 * the player, e.g. giving the player gold, hp and taking away the AP.
 * 
